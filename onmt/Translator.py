...
class Translator(object):
    ...
    def translateBatch(self, srcBatch, tgtBatch):
        ...
        encStates = self.model.encode(srcBatch)
        ...
        goldScores = torch.FloatTensor(batchSize).zero_()
        ...
        decStates = Variable(encStates.data.repeat(beamSize, 1))
        ...
        for i in range(self.opt.max_sent_length):
            ...
            decOut = self.model.decode(
                decStates, Variable(input, volatile=True))
            ...
            decStates = updateActive(decStates)
